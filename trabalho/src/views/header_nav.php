...
<!-- Logo e link do logo -->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="https://www.youtube.com/watch?v=ILGACkE2XCgp">te amamos sor clica aqui</a>
        </li>
      ...
      <form class="d-flex">
        ...
        &nbsp;
        <button class="btn btn-outline-danger" type="submit" href="../sessao-end.php">Encerrar sessão</button>
      </form>
    </div>
  </div>
</nav>
